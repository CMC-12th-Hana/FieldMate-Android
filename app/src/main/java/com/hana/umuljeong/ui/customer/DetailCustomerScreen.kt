...
fun DetailCustomerScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            DetailCustomerContent(customer = fakeCustomerData[customerId.toInt()])
        }
    }
}
...
fun DetailCustomerContent(
    ...
    Row(
        ...
        Text(text = "${customer.name}와 함께한 사업")
    }
